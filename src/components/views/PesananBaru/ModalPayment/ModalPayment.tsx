...
import useModalPeymanet from "./useModalPayment";
...
const ModalPayment = (props: PropTypes) => {
    const { isOpen, onClose, onOpenChange, cart, subtotal, pelanggan, refetch } = props;
    ...
    const {
        ...
        exactAmount,
        roundedAmount,
    } = useModalPeymanet(cart, subtotal, String(pelanggan))
    return (
        <Modal
                ...
                <ModalBody className="p-0">
                    <div className="flex h-[calc(100vh-85px)]">
                        ...
                        <div className="w-full">
                            <div className="flex flex-col justify-center items-center gap-1 py-3 border-b border-secondary/20">
                                <p className="font-semibold text-secondary">Total Penerimaan</p>
                                <h1 className="text-3xl font-bold text-primary tracking-wide">{convertIDR(Number(subtotal))}</h1>
                            </div>
                            <div className="p-5 flex flex-col justify-center items-center">
                                <Tabs 
                                    ...
                                    classNames={{
                                        ...
                                        tab: "h-12 p-0 mb-3",
                                        tabContent: "group-data-[selected=true]:text-black group-data-[selected=true]:font-bold text-xl",
                                    }}
                                >
                                    <Tab key="tunai" title="Tunai" className="w-full" >
                                        <div className="flex flex-col justify-between gap-10 h-[calc(100vh-280px)] overflow-y-scroll">
                                            <div>
                                            ...
                                            <Button 
                                                className="w-full text-xl min-h-[50px] font-semibold bg-primary" 
                                                size="lg"
                                                onPress={() => handlePrint(onClose, refetch)}
                                            >
                                                Bayar
                                            </Button>
                                        </div>
